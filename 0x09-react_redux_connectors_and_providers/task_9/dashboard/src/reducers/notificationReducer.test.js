...
const defaultNotificationReducer = {
    notifications: [],
    filter: 'DEFAULT',
};

it('default case with no action', () => {
    const initialCase = notificationReducer(defaultNotificationReducer, {});
    expect(initialCase.toJS()).toEqual(defaultNotificationReducer);
});
